...
$layout->FormBox(
			Array(
				0=>"Date:",
				1=>$layout->Field("ocl_date", "text", $default[ocl_date], "", "class='datetimepicker'")
			)
);	
$layout->FormBox(
			Array(
...
$layout->FormBox(
		array(
			...
			1=>$layout->Field("service_var", "hidden", $default[ocl_service_var]) . "<a  class='btn btn-xs btn-primary' href='javascript:GrpChk();'>Open Service selector</A>" . $layout->Field("Subm", "button", "next->", "" ," onClick='xajax_ExtensionAjax(\"OcL\", \"xajax_ocl_add_form\", xajax.getFormValues(\"fm1\"))'")
