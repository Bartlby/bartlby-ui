<table  width='100%'>
		<tr>
			...
			<td align=left ><?=$plcs[service][service_snmp_community]?></font></td>
			<td>&nbsp;</td>           
		</tr>
		<tr>
			<td width=150 class='font2'>Object ID:</td>
			<td align=left ><?=$plcs[service][service_snmp_objid]?></font></td>
			<td>&nbsp;</td>           
		</tr>
		<tr>
			<td width=150 class='font2'>Protocol Version:</td>
			<td align=left ><?=$plcs[service][service_snmp_version]?></font></td>
			<td>&nbsp;</td>           
		</tr>
		<tr>
			<td width=150 class='font2'>Warning:</td>
			<td align=left ><?=$plcs[service][service_snmp_warning]?></font></td>
			<td>&nbsp;</td>           
		</tr>
		<tr>
			<td width=150 class='font2'>Critical:</td>
			<td align=left ><?=$plcs[service][service_snmp_critical]?></font></td>
			<td>&nbsp;</td>           
		</tr>
		<tr>
