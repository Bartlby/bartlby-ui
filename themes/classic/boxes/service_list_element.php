...
?>
	...
	<tr>
		<td   align=left  valign=top width='1'  class='<?=$plcs[services][$s_element]["class"]?>'>
			<a href='server_detail.php?server_id=<?=$plcs[services][$s_element][server_id]?>'><b><?=$plcs[services][$s_element][server_name]?></A> <?=$btl->getServerOPtions($plcs[services][$s_element], $layout)?>
