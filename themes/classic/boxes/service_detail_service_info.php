...
<table  width='100%' style='min-height:627px;'>
	...
	<tr>
		<td width=150 class='font2'>Priority:</td>
		<td align=left ><?=$plcs[service][prio]?></font></td>
		<td>&nbsp;</td>           
	</tr>
	<tr>
		<td width=150 class='font2'>Uniqe Service Identifier (usid):</td>
		<td align=left ><?=$plcs[service][usid]?></font></td>
		<td>&nbsp;</td>           
	</tr>
	<tr>
		<td width=150 class='font2'>Notify Super Users?:</td>
		<td align=left ><?=($plcs[service][notify_super_users]==1) ? "true" : "false" ?></font></td>
		<td>&nbsp;</td>           
	</tr>
